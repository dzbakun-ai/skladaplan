-- =========================================================
-- !!! УСТАРЕЛО — НЕ ВЫПОЛНЯТЬ НА НОВОЙ БАЗЕ !!!
--
-- Этот файл создавал таблицу public.tasks для модуля
-- tasks.js, которого больше нет. Единственный источник
-- задач теперь — public.planner_tasks.
--
-- Файл оставлен только как документация: из него видно,
-- какие поля были у public.tasks и откуда берутся данные,
-- которые переносит supabase_migration_tasks_unify.sql.
--
-- Если public.tasks у вас уже создана — ничего делать не
-- нужно, просто выполните supabase_migration_tasks_unify.sql.
-- Если её нет — этот файл вам не нужен вообще.
-- =========================================================
