    ...
    <div class="help-page">
      ...
      >
        ...
        <div class="help-dropdown-body">
          ...
          <ul class="help-bullets">
            ...
            <li>
              Фильтровать по дате комплектации:
              сегодня, вчера или произвольный период.
            </li>

            <li>
              Смотреть статистику: сколько собрано
              за выбранный период и в разбивке
              по направлениям.
            </li>

            <li>
              Кнопка «Проверка скомплектованного» —
              выбрать направление, отсканировать
              коробки и сверить с ожидаемым списком
              (похоже на инвентаризацию, но отдельно
              и только для уже скомплектованных
              коробок).
            </li>
      ...
      >
        ...
        <div class="help-dropdown-body">
          ...
          <p class="help-lead">
            Раздел для переноса коробок и целых паллет
            на новое место — другую зону, поддон или склад.
          </p>

          <ul class="help-bullets">

            <li>
              Отсканируйте коробки одну за другой —
              они появятся в списке выбранных.
            </li>

            <li>
              Либо выберите готовую паллету целиком
              через «Добавить паллету».
            </li>

            <li>
              Если вы уже отметили коробки в Базе —
              они автоматически подставятся сюда.
            </li>

            <li>
              Укажите новый склад / зону / поддон
              и нажмите «Переместить».
            </li>

            <li>
              Перемещение выполняется одной операцией —
              переехали либо все выбранные коробки,
              либо ни одна (при ошибке ничего
              не потеряется и не «зависнет»).
            </li>
      ...
      >
        ...
        <div class="help-dropdown-body">
          ...
          <p style="margin-top:12px;">
            Отгрузка теперь фиксирует, кто и когда
            отгрузил каждую коробку, и выполняется
            одной операцией на всю выбранную партию —
            если что-то пошло не так, не отгрузится
            ни одна коробка, а не «половина».
          </p>
      ...
      >
        ...
        <div class="help-dropdown-body">
          ...
          <p class="help-lead" style="margin-top:16px;">
            На главном экране инвентаризации есть кнопка
            «Объединить неполные паллеты» — она переносит
            коробки с нескольких неполных паллет на одну
            (например, было P-001 с 8 коробками и P-002
            с 5 — стало P-001 с 13). Каждая коробка
            остаётся отдельной физической записью,
            меняется только её паллета. Пустые исходные
            паллеты автоматически помечаются архивными.
          </p>
